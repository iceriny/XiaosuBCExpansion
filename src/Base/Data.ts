...
export class DataBody<T extends IDataBody> {
    ...
    getLocalKeyFromKey(key: keyof T): string {
        return `XSBE_${Player.AccountName}_${key as string}`;
    }
    /**
     * 将时间戳保存到本地空间
     */
